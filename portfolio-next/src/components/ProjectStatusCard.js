        ...
        <Card padding="lg" radius="sm" withBorder>
            <Group position="apart" mt="md" mb="xl">
                ...
                <Group position="apart" >
                    <Link href={github ?? '/'}><Badge variant="light">Page</Badge> </Link>
                    <Link href={github + '/fork' ?? '/'}><Badge color="red" variant="light">Fork</Badge></Link>
                </Group>
            </Group>
            { urls.data?.map((url) => 
                <Group key={url} position="apart">
                    ...
                    <Link style={{textDecoration: 'none'}} href={url.attributes.url ?? '/'}><Text >{url.attributes.url}<HiExternalLink/></Text></Link>
                </Group>
            )}      
        </Card>
    )
